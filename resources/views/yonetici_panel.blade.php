    ...
    <div class="content" id="web">
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" id="slogan" placeholder="Slogan giriniz">
            </div>
            <div class="form-group">
                <label for="vizyon">Vizyon</label>
                <textarea id="vizyon" rows="2" placeholder="Vizyon giriniz"></textarea>
            </div>
            <div class="form-group">
                <label for="misyon">Misyon</label>
                <textarea id="misyon" rows="2" placeholder="Misyon giriniz"></textarea>
            </div>
        </div>
    </div>
